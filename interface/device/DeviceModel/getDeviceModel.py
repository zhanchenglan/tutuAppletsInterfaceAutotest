#!/usr/bin/python3
# -*- coding: utf-8 -*-
# @Time    : 2019/8/23 15:06
# @Author  : Durat
# @Email   : durant.zeng@sunvalley.com.cn
# @File    : getDeviceModel.py
# @Software: PyCharm
...
class getDeviceModel:
    ...
    def get_getDeviceModelURL(self,baseURL,URL,lang,timeStamp,clientVersionInfo,access_token):
        '''
        :param baseURL:
        :param lang:
        :param timeStamp:
        ...
        :return:获取设备模式接口
        '''
        getDeviceModelURL = baseURL + URL + "?lang=%s&timeStamp=%s&clientVersionInfo=%s&access_token=%s" % (lang, timeStamp, clientVersionInfo,access_token)
