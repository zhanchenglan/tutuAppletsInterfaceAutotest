#!/usr/bin/python3
# -*- coding: utf-8 -*-
# @Time    : 2020/3/12 11:10
# @Author  : Durat
# @Email   : durant.zeng@sunvalley.com.cn
# @File    : test_case_deleteAlbumsCommentReply.py
# @Software: PyCharm
...
class TestdeleteAlbumsCommentReplyFunc(unittest.TestCase):
    """Test deleteAlbumsCommentReply.py"""
    ...
    @unittest.skip("暂时遮蔽")
    def test_deleteAlbumsCommentReply_tutu_Applets_001(self):
        '''美甲涂涂Applets端_删除专辑评论回复_正常回复_手机号密码登录_001'''
        #安卓登录
        ...
        #删除专辑回复评论
        deleteAlbumsCommentReplyURL = self.deleteAlbumsCommentReply.get_deleteAlbumsCommentReplyURL(self.config.get('imi_base_url_ch', 'base_url_prod'),
