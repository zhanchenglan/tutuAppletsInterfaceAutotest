...
class TestgetAlbumsCommentReplySimpleListFunc(unittest.TestCase):
    ...
    def test_addAlbumsCommentReplyComplaint_tutu_Applets_001(self):
        '''美甲涂涂Applets端_回复—评论投诉_正常投诉_手机号密码登录_001'''
        #安卓登录
        ...
        app_login_url_ch = self.AC.get_AuthenticationURL(self.config.get('imi_base_url_ch', 'base_url_uat'),self.config.get("imi_login_url","login_url"),self.config.get("lang", "zh"),self.base.getTimeStamp(),self.config.get("clientVersionInfo", "clientVersionInfo_ch_Android"))
        ...
        #发表专辑评论
        addAlbumsCommentURL = self.addAlbumsComment.get_addAlbumsCommentURL(self.config.get('imi_base_url_ch', 'base_url_uat'),
                                                  self.config.get("AlbumsComment", "addAlbumsCommentURL"), self.config.get("lang", "zh"),
                                                  self.base.getTimeStamp(),
                                                  self.config.get("clientVersionInfo", "clientVersionInfo_ch_Android"),access_token)
        comment_content = self.base.get_random_content()
        result_addAlbumsComment = self.addAlbumsComment.send_request_addAlbumsComment(addAlbumsCommentURL,albumsId,comment_content)

        self.assertEqual(result_addAlbumsComment["stateCode"], 200)
        self.assertEqual(result_addAlbumsComment["stateMsg"], "OK")

        #专辑评论列表查询
        getAlbumsCommentListURL = self.getAlbumsCommentList.get_getAlbumsCommentListURL(self.config.get('imi_base_url_ch', 'base_url_uat'),
        ...
        #回复专辑评论
        addAlbumsCommentReplyURL = self.addAlbumsCommentReply.get_addAlbumsCommentReplyURL(self.config.get('imi_base_url_ch', 'base_url_uat'),
        ...
        result_addAlbumsCommentReply = self.addAlbumsCommentReply.send_request_addAlbumsCommentReply(addAlbumsCommentReplyURL,commentId,reply_content,replyId,replyType,toUid,toUidNickname,toUidHeadPortrait)
        ...
        #回复—列表查询(简单形)
        getAlbumsCommentReplySimpleListURL = self.getAlbumsCommentReplySimpleList.get_getAlbumsCommentReplySimpleListURL(self.config.get('imi_base_url_ch', 'base_url_uat'),
        ...
        #专辑评论--回复投诉
        addAlbumsCommentReplyComplaintURL = self.addAlbumsCommentReplyComplaint.get_addAlbumsCommentReplyComplaintURL(self.config.get('imi_base_url_ch', 'base_url_uat'),
                                                  self.config.get("AlbumsComment", "addAlbumsCommentReplyComplaintURL"), self.config.get("lang", "zh"),
                                                  self.base.getTimeStamp(),
                                                  self.config.get("clientVersionInfo", "clientVersionInfo_ch_Android"),access_token)

        commentId = result_getAlbumsCommentReplySimpleList["data"][0]["id"]
        complaintTypeList = [1,2,3,4]
        content = result_getAlbumsCommentList["data"][0]["content"]
        replyType = "1"
        uid = result_getAlbumsCommentReplySimpleList["data"][0]["replyId"]
        replyId = result_getAlbumsCommentReplySimpleList["data"][0]["replyId"]
        toUid = ""
        ...
        #删除专辑回复评论
        deleteAlbumsCommentReplyURL = self.deleteAlbumsCommentReply.get_deleteAlbumsCommentReplyURL(self.config.get('imi_base_url_ch', 'base_url_uat'),
        ...
        completeDel = False
        result_deleteAlbumsCommentReply = self.deleteAlbumsCommentReply.send_request_deleteAlbumsCommentReply(deleteAlbumsCommentReplyURL,replyId,completeDel)
        ...
        #删除专辑评论
        deleteAlbumsCommentURL = self.deleteAlbumsComment.get_deleteAlbumsCommentURL(self.config.get('imi_base_url_ch', 'base_url_uat'),
